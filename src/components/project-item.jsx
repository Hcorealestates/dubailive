...
export default function ProjectItem({ projectObject }) {
  return <>
    ...
    <figcaption className='p-4 pb-0'>
      <h5 className="text-center text-lg md:text-xl mb-3 max-sm:line-clamp-1"><Link href={projectObject.propurl} className=' before:absolute before:inset-0'>{projectObject.propname}</Link></h5>
